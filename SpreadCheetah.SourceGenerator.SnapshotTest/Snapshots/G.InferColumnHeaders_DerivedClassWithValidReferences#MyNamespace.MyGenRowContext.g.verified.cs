...
namespace MyNamespace
{
    ...
    public partial class MyGenRowContext
    {
        ...
        private WorksheetRowTypeInfo<MyNamespace.DerivedClassWithInferColumnHeaders>? _DerivedClassWithInferColumnHeaders;

        /// <summary>
        /// Defines the source generated worksheet row metadata for a given type.
        /// </summary>
        public WorksheetRowTypeInfo<MyNamespace.DerivedClassWithInferColumnHeaders> DerivedClassWithInferColumnHeaders => _DerivedClassWithInferColumnHeaders
            ??= WorksheetRowMetadataServices.CreateObjectInfo<MyNamespace.DerivedClassWithInferColumnHeaders>(
        ...
        private static ValueTask AddAsRowAsync(SpreadCheetah.Spreadsheet spreadsheet, MyNamespace.DerivedClassWithInferColumnHeaders? obj, CancellationToken token)
        {
        ...
        private static ValueTask AddRangeAsRowsAsync(SpreadCheetah.Spreadsheet spreadsheet,
            IEnumerable<MyNamespace.DerivedClassWithInferColumnHeaders?> objs,
        ...
        private static async ValueTask AddAsRowInternalAsync(SpreadCheetah.Spreadsheet spreadsheet,
            MyNamespace.DerivedClassWithInferColumnHeaders obj,
            CancellationToken token)
        {
