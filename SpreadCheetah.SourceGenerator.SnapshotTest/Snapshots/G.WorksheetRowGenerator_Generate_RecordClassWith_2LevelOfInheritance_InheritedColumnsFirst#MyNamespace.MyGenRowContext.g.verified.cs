...
namespace MyNamespace
{
    public partial class MyGenRowContext
    {
        ...
        public WorksheetRowTypeInfo<SpreadCheetah.SourceGenerator.SnapshotTest.Models.InheritColumns.RecordClass2LevelOfInheritanceInheritedColumnsFirst> RecordClass2LevelOfInheritanceInheritedColumnsFirst => _RecordClass2LevelOfInheritanceInheritedColumnsFirst
            ??= WorksheetRowMetadataServices.CreateObjectInfo<SpreadCheetah.SourceGenerator.SnapshotTest.Models.InheritColumns.RecordClass2LevelOfInheritanceInheritedColumnsFirst>(
        ...
        private static async ValueTask AddHeaderRow0Async(SpreadCheetah.Spreadsheet spreadsheet, SpreadCheetah.Styling.StyleId? styleId, CancellationToken token)
        {
            ...
            try
            {
                ...
                cells[2] = new StyledCell("OwnProperty", styleId);
        ...
        private static ValueTask AddRangeAsRowsAsync(SpreadCheetah.Spreadsheet spreadsheet,
            IEnumerable<SpreadCheetah.SourceGenerator.SnapshotTest.Models.InheritColumns.RecordClass2LevelOfInheritanceInheritedColumnsFirst?> objs,
        ...
        private static async ValueTask AddAsRowInternalAsync(SpreadCheetah.Spreadsheet spreadsheet,
            SpreadCheetah.SourceGenerator.SnapshotTest.Models.InheritColumns.RecordClass2LevelOfInheritanceInheritedColumnsFirst obj,
            CancellationToken token)
        {
            ...
            DataCell[] cells, IReadOnlyList<StyleId> styleIds, CancellationToken token)
        {
            ...
            cells[2] = new DataCell(obj.OwnProperty);
