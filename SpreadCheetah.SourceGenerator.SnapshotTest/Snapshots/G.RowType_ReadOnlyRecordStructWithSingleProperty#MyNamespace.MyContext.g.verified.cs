...
namespace MyNamespace
{
    public partial class MyContext
    {
        ...
        private WorksheetRowTypeInfo<MyNamespace.MyReadOnlyRecordStruct>? _MyReadOnlyRecordStruct;
        public WorksheetRowTypeInfo<MyNamespace.MyReadOnlyRecordStruct> MyReadOnlyRecordStruct => _MyReadOnlyRecordStruct
            ??= WorksheetRowMetadataServices.CreateObjectInfo<MyNamespace.MyReadOnlyRecordStruct>(
        ...
        private static ValueTask AddAsRowAsync(SpreadCheetah.Spreadsheet spreadsheet, MyNamespace.MyReadOnlyRecordStruct obj, CancellationToken token)
        {
        ...
        private static ValueTask AddRangeAsRowsAsync(SpreadCheetah.Spreadsheet spreadsheet,
            IEnumerable<MyNamespace.MyReadOnlyRecordStruct> objs,
        ...
        private static async ValueTask AddAsRowInternalAsync(SpreadCheetah.Spreadsheet spreadsheet,
            MyNamespace.MyReadOnlyRecordStruct obj,
            CancellationToken token)
        {
