...
namespace MyNamespace
{
    ...
    public partial class MyGenRowContext
    {
        ...
        private WorksheetRowTypeInfo<MyNamespace.ClassWithDefaultColumnWidth>? _ClassWithDefaultColumnWidth;

        /// <summary>
        /// Defines the source generated worksheet row metadata for a given type.
        /// </summary>
        public WorksheetRowTypeInfo<MyNamespace.ClassWithDefaultColumnWidth> ClassWithDefaultColumnWidth => _ClassWithDefaultColumnWidth
            ??= WorksheetRowMetadataServices.CreateObjectInfo<MyNamespace.ClassWithDefaultColumnWidth>(
        ...
        private static ValueTask AddAsRowAsync(SpreadCheetah.Spreadsheet spreadsheet, MyNamespace.ClassWithDefaultColumnWidth? obj, CancellationToken token)
        {
