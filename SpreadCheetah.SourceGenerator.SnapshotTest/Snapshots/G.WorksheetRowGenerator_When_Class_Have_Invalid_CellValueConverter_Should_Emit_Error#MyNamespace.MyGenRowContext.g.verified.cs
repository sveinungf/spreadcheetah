...
namespace MyNamespace
{
    public partial class MyGenRowContext
    {
        ...
        private WorksheetRowTypeInfo<SpreadCheetah.SourceGenerator.SnapshotTest.Models.CellValueConverters.ClassWithInvalidCellValueConverter>? _ClassWithInvalidCellValueConverter;
        public WorksheetRowTypeInfo<SpreadCheetah.SourceGenerator.SnapshotTest.Models.CellValueConverters.ClassWithInvalidCellValueConverter> ClassWithInvalidCellValueConverter => _ClassWithInvalidCellValueConverter
            ??= WorksheetRowMetadataServices.CreateObjectInfo<SpreadCheetah.SourceGenerator.SnapshotTest.Models.CellValueConverters.ClassWithInvalidCellValueConverter>(
        ...
        private static ValueTask AddAsRowAsync(SpreadCheetah.Spreadsheet spreadsheet, SpreadCheetah.SourceGenerator.SnapshotTest.Models.CellValueConverters.ClassWithInvalidCellValueConverter? obj, CancellationToken token)
        {
        ...
        private static ValueTask AddRangeAsRowsAsync(SpreadCheetah.Spreadsheet spreadsheet,
            IEnumerable<SpreadCheetah.SourceGenerator.SnapshotTest.Models.CellValueConverters.ClassWithInvalidCellValueConverter?> objs,
        ...
        private static async ValueTask AddAsRowInternalAsync(SpreadCheetah.Spreadsheet spreadsheet,
            SpreadCheetah.SourceGenerator.SnapshotTest.Models.CellValueConverters.ClassWithInvalidCellValueConverter obj,
            CancellationToken token)
        {
