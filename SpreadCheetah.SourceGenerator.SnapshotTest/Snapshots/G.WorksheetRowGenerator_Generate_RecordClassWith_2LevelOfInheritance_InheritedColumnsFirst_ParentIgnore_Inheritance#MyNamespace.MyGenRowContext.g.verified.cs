...
namespace MyNamespace
{
    public partial class MyGenRowContext
    {
        ...
        public WorksheetRowTypeInfo<SpreadCheetah.SourceGenerator.SnapshotTest.Models.InheritColumns.RecordClass2LevelOfInheritanceInheritedColumnsFirstParentIgnoreInheritance> RecordClass2LevelOfInheritanceInheritedColumnsFirstParentIgnoreInheritance => _RecordClass2LevelOfInheritanceInheritedColumnsFirstParentIgnoreInheritance
            ??= WorksheetRowMetadataServices.CreateObjectInfo<SpreadCheetah.SourceGenerator.SnapshotTest.Models.InheritColumns.RecordClass2LevelOfInheritanceInheritedColumnsFirstParentIgnoreInheritance>(
        ...
        private static ValueTask AddRangeAsRowsAsync(SpreadCheetah.Spreadsheet spreadsheet,
            IEnumerable<SpreadCheetah.SourceGenerator.SnapshotTest.Models.InheritColumns.RecordClass2LevelOfInheritanceInheritedColumnsFirstParentIgnoreInheritance?> objs,
        ...
        private static async ValueTask AddAsRowInternalAsync(SpreadCheetah.Spreadsheet spreadsheet,
            SpreadCheetah.SourceGenerator.SnapshotTest.Models.InheritColumns.RecordClass2LevelOfInheritanceInheritedColumnsFirstParentIgnoreInheritance obj,
            CancellationToken token)
        {
