...
namespace MyNamespace
{
    internal partial class MyGenRowContext
    {
        ...
        public WorksheetRowTypeInfo<MyNamespace.InternalClassWithSingleProperty> InternalClassWithSingleProperty => _InternalClassWithSingleProperty
            ??= WorksheetRowMetadataServices.CreateObjectInfo<MyNamespace.InternalClassWithSingleProperty>(
        ...
        private static ValueTask AddRangeAsRowsAsync(SpreadCheetah.Spreadsheet spreadsheet,
            IEnumerable<MyNamespace.InternalClassWithSingleProperty?> objs,
        ...
        private static async ValueTask AddAsRowInternalAsync(SpreadCheetah.Spreadsheet spreadsheet,
            MyNamespace.InternalClassWithSingleProperty obj,
            CancellationToken token)
        {
