...
namespace MyNamespace
{
    ...
    internal partial class MyContext
    {
        ...
        private WorksheetRowTypeInfo<MyNamespace.MyInternalClass>? _MyInternalClass;

        /// <summary>
        /// Defines the source generated worksheet row metadata for a given type.
        /// </summary>
        public WorksheetRowTypeInfo<MyNamespace.MyInternalClass> MyInternalClass => _MyInternalClass
            ??= WorksheetRowMetadataServices.CreateObjectInfo<MyNamespace.MyInternalClass>(
        ...
        private static ValueTask AddAsRowAsync(SpreadCheetah.Spreadsheet spreadsheet, MyNamespace.MyInternalClass? obj, CancellationToken token)
        {
        ...
        private static ValueTask AddRangeAsRowsAsync(SpreadCheetah.Spreadsheet spreadsheet,
            IEnumerable<MyNamespace.MyInternalClass?> objs,
        ...
        private static async ValueTask AddAsRowInternalAsync(SpreadCheetah.Spreadsheet spreadsheet,
            MyNamespace.MyInternalClass obj,
            CancellationToken token)
        {
