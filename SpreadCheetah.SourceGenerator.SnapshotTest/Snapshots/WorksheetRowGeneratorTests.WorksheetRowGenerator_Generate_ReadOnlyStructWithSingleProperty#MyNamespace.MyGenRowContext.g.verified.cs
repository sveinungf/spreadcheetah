...
namespace MyNamespace
{
    public partial class MyGenRowContext
    {
        ...
        public WorksheetRowTypeInfo<SpreadCheetah.SourceGenerator.SnapshotTest.Models.ReadOnlyStructWithSingleProperty> ReadOnlyStructWithSingleProperty => _ReadOnlyStructWithSingleProperty ??= WorksheetRowMetadataServices.CreateObjectInfo<SpreadCheetah.SourceGenerator.SnapshotTest.Models.ReadOnlyStructWithSingleProperty>(AddAsRowAsync, AddRangeAsRowsAsync);

        private static async ValueTask AddHeaderRowAsync(SpreadCheetah.Spreadsheet spreadsheet, SpreadCheetah.SourceGenerator.SnapshotTest.Models.ReadOnlyStructWithSingleProperty _, SpreadCheetah.Styling.StyleId? styleId, CancellationToken token)
        {
