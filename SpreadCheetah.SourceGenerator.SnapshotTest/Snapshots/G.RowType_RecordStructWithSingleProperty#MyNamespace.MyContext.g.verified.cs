...
namespace MyNamespace
{
    public partial class MyContext
    {
        ...
        private WorksheetRowTypeInfo<MyNamespace.MyRecordStruct>? _MyRecordStruct;
        public WorksheetRowTypeInfo<MyNamespace.MyRecordStruct> MyRecordStruct => _MyRecordStruct
            ??= WorksheetRowMetadataServices.CreateObjectInfo<MyNamespace.MyRecordStruct>(
        ...
        private static ValueTask AddAsRowAsync(SpreadCheetah.Spreadsheet spreadsheet, MyNamespace.MyRecordStruct obj, CancellationToken token)
        {
        ...
        private static ValueTask AddRangeAsRowsAsync(SpreadCheetah.Spreadsheet spreadsheet,
            IEnumerable<MyNamespace.MyRecordStruct> objs,
        ...
        private static async ValueTask AddAsRowInternalAsync(SpreadCheetah.Spreadsheet spreadsheet,
            MyNamespace.MyRecordStruct obj,
            CancellationToken token)
        {
