...
namespace MyNamespace
{
    public partial class MyGenRowContext
    {
        ...
        public WorksheetRowTypeInfo<MyNamespace.ClassWithCellValueTruncate> ClassWithCellValueTruncate => _ClassWithCellValueTruncate
            ??= WorksheetRowMetadataServices.CreateObjectInfo<MyNamespace.ClassWithCellValueTruncate>(AddHeaderRow0Async, AddAsRowAsync, AddRangeAsRowsAsync);
        ...
        private static ValueTask AddRangeAsRowsAsync(SpreadCheetah.Spreadsheet spreadsheet, IEnumerable<MyNamespace.ClassWithCellValueTruncate?> objs, CancellationToken token)
        {
            if (spreadsheet is null)
                throw new ArgumentNullException(nameof(spreadsheet));
            if (objs is null)
        ...
        private static async ValueTask AddRangeAsRowsInternalAsync(SpreadCheetah.Spreadsheet spreadsheet, IEnumerable<MyNamespace.ClassWithCellValueTruncate?> objs, CancellationToken token)
        {
            var cells = ArrayPool<DataCell>.Shared.Rent(1);
            try
            {
        ...
        private static async ValueTask AddEnumerableAsRowsAsync(SpreadCheetah.Spreadsheet spreadsheet, IEnumerable<MyNamespace.ClassWithCellValueTruncate?> objs, DataCell[] cells, CancellationToken token)
        {
