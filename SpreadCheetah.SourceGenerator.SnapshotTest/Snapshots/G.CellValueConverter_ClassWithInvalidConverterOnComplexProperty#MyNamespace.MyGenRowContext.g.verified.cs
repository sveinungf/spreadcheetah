...
namespace MyNamespace
{
    public partial class MyGenRowContext
    {
        ...
        private WorksheetRowTypeInfo<MyNamespace.ClassWithInvalidConverterOnComplexProperty>? _ClassWithInvalidConverterOnComplexProperty;
        public WorksheetRowTypeInfo<MyNamespace.ClassWithInvalidConverterOnComplexProperty> ClassWithInvalidConverterOnComplexProperty => _ClassWithInvalidConverterOnComplexProperty
            ??= WorksheetRowMetadataServices.CreateObjectInfo<MyNamespace.ClassWithInvalidConverterOnComplexProperty>(
        ...
        private static async ValueTask AddHeaderRow0Async(SpreadCheetah.Spreadsheet spreadsheet, SpreadCheetah.Styling.StyleId? styleId, CancellationToken token)
        {
            ...
            try
            {
                cells[0] = new StyledCell("Property2", styleId);
        ...
        private static ValueTask AddAsRowAsync(SpreadCheetah.Spreadsheet spreadsheet, MyNamespace.ClassWithInvalidConverterOnComplexProperty? obj, CancellationToken token)
        {
        ...
        private static ValueTask AddRangeAsRowsAsync(SpreadCheetah.Spreadsheet spreadsheet,
            IEnumerable<MyNamespace.ClassWithInvalidConverterOnComplexProperty?> objs,
        ...
        private static async ValueTask AddAsRowInternalAsync(SpreadCheetah.Spreadsheet spreadsheet,
            MyNamespace.ClassWithInvalidConverterOnComplexProperty obj,
            CancellationToken token)
        {
            ...
            DataCell[] cells, IReadOnlyList<StyleId> styleIds, CancellationToken token)
        {
            ...
            cells[0] = new DataCell(obj.Property2);
