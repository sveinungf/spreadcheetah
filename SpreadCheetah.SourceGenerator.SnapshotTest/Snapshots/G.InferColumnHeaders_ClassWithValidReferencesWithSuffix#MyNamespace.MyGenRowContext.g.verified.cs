...
namespace MyNamespace
{
    ...
    public partial class MyGenRowContext
    {
        ...
        private WorksheetRowTypeInfo<MyNamespace.ClassWithInferColumnHeaders>? _ClassWithInferColumnHeaders;

        /// <summary>
        /// Defines the source generated worksheet row metadata for a given type.
        /// </summary>
        public WorksheetRowTypeInfo<MyNamespace.ClassWithInferColumnHeaders> ClassWithInferColumnHeaders => _ClassWithInferColumnHeaders
            ??= WorksheetRowMetadataServices.CreateObjectInfo<MyNamespace.ClassWithInferColumnHeaders>(
        ...
        private static ValueTask AddAsRowAsync(SpreadCheetah.Spreadsheet spreadsheet, MyNamespace.ClassWithInferColumnHeaders? obj, CancellationToken token)
        {
        ...
        private static ValueTask AddRangeAsRowsAsync(SpreadCheetah.Spreadsheet spreadsheet,
            IEnumerable<MyNamespace.ClassWithInferColumnHeaders?> objs,
        ...
        private static async ValueTask AddAsRowInternalAsync(SpreadCheetah.Spreadsheet spreadsheet,
            MyNamespace.ClassWithInferColumnHeaders obj,
            CancellationToken token)
        {
