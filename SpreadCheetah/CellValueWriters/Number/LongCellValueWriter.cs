...
internal sealed class LongCellValueWriter : NumberCellValueWriter
{
    public override bool TryWriteCell(in DataCell cell, CellWriterState state)
    {
        return state.Buffer.TryWrite($"{BeginDataCell}{cell.Value.StringOrPrimitive.PrimitiveValue.LongValue}{EndDefaultCell}");
    }
    ...
    public override bool TryWriteCell(in DataCell cell, StyleId styleId, SpreadsheetBuffer buffer)
    {
        return buffer.TryWrite(
            ...
            $"{cell.Value.StringOrPrimitive.PrimitiveValue.LongValue}" +
            $"{EndDefaultCell}");
    }
    ...
    public override bool TryWriteCell(string formulaText, in DataCell cachedValue, StyleId? styleId, CellWriterState state)
    {
        if (styleId is { } style)
        {
            return state.Buffer.TryWrite(
                ...
                $"{cachedValue.Value.StringOrPrimitive.PrimitiveValue.LongValue}" +
    ...
    {
        return buffer.TryWrite($"{cell.Value.StringOrPrimitive.PrimitiveValue.LongValue}");
    }
}
