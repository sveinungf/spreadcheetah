...
#pragma warning restore CA2213 // Disposed by Spreadsheet
    ...
    public List<ImmutableConditionalFormatRule>? ConditionalFormatRules { get; private set; }
    ...
    public void AddConditionalFormatting(string reference, ConditionalFormatRule rule)
    {
        ...
        var immutableRule = rule.ToImmutable(cellReference);
        ConditionalFormatRules.Add(immutableRule);
    }
