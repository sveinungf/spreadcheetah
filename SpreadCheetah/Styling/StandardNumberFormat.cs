...
public enum StandardNumberFormat
{
    ...
    LongTime = 21,
    /// <summary>Format as locale dependent date and time with day, month, year, hour and minute.</summary>
    DateAndTime = 22,
    ...
    Duration = 46,
    /// <summary>Format as locale dependent duration as a number of minutes and seconds, and one decimal place.</summary>
    DecimalDuration = 47,
    /// <summary>Format as a number between 1 and 10 multiplied by a power of 10.</summary>
    Exponential = 48,
