...
";
        ...
        private static void ReportDiagnostics(GeneratorExecutionContext context, IEnumerable<ClassPropertiesInfo> infos)
        {
            foreach (var info in infos)
            {
                ...
                if (info.UnsupportedPropertyNames.Count > 0)
                    context.ReportDiagnostics(Diagnostics.UnsupportedTypeForCellValue, info.Locations, info.ClassType, info.UnsupportedPropertyNames[0]);
            }
        }
